...
namespace GET3G_PC.Controls
{
    public partial class GasCurveCtrl : UserControl
    {
        ...
        public void DisplayGasCurve()
        {
            ...
            //绘制时间X轴名称
            bufferGrp.Graphics.DrawString("时间，min", font, Brushes.White, new PointF(this.panCurve.Width/2-Y_PADDING, this.panCurve.Height-Y_PADDING-10f));
            ...
            bufferGrp.Graphics.DrawString("发气量，ml/g", font, Brushes.Red, new PointF(0, 0));
            ...
            bufferGrp.Graphics.DrawString("发气速度，ml/g/s", font, Brushes.Yellow, new PointF(0f, 0f));
