...
namespace GET3G_PC.Controls
{
    ...
    public class GasDataToPrint
    {
        ...
        public void DrawGasDatas(Graphics graphicsToPrint)
        {
            ...
            //绘制时间X轴名称
            graphicsToPrint.DrawString("时间，min", font, Brushes.Black, new PointF(this.rectToPrint.Width / 2 - Y_PADDING, this.rectToPrint.Height+160f));
            ...
            graphicsToPrint.DrawString("试样名称:" + this.sampleName, fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 280f));
            graphicsToPrint.DrawString("试样编号:" + this.sampleNumber, fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING -100f, 310f));
            graphicsToPrint.DrawString("试样重量:" + this.sampleWeight + "g", fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING -100f, 340f));
            graphicsToPrint.DrawString("重复次数:" + this.sampleRepeat + "次", fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING -100f, 370f));
            graphicsToPrint.DrawString("最大发气量:" + this.gas + " ml/g", fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 400f));
            graphicsToPrint.DrawString("发气速度:" + this.GasIncrement + " ml/g/s", fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 430f));
            graphicsToPrint.DrawString("实验时间:" + this.testTime + " mm:ss", fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 460f)); 
            graphicsToPrint.DrawString("测试温度:" + this.furnaceTargetTemperature + "℃", fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 490f));
            graphicsToPrint.DrawString("测试单位:" + this.factory, fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 520f));
            graphicsToPrint.DrawString("测试人员:" + this.people, fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 550f));
            graphicsToPrint.DrawString("测试日期:" + DateTime.Now.ToString("yyyy-MM-d"), fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 580f));
            graphicsToPrint.DrawString("测试时间:" + DateTime.Now.ToString("HH:mm:ss"), fontSample, Brushes.Black, new PointF(this.rectToPrint.Width + 2 * X_PADDING - 100f, 610f));
            ///////////////////////////////////////////////////////////////////////////////////////////
...
///////////旋转部分////////////////////////////
            ...
            graphicsToPrint.DrawString("发气量，ml/g", font, Brushes.Red, new PointF(0, 0));
